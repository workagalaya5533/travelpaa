...
<body>
    <section class="hero-section">
        ...
        <div class="main-content">
            ...
            <div class="tagline" id="tagline">
                <i data-lucide="heart" class="tagline-heart"></i>
                <span class="tagline-text">Emotional Travel Intelligence • Feel-First Journey</span>
                <i data-lucide="compass" class="tagline-compass"></i>
            </div>
            ...
            <!-- Description -->
            <p class="description">
                <span class="blue-text">Discover your emotional compass</span> and let your feelings guide you to <span class="teal-text">extraordinary destinations</span>. <br>
            ...
            <div class="buttons-container">
                ...
                <button class="btn btn-outline">Discover Emotions</button>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        document.getElementById('tagline').addEventListener('mouseenter', function() {
            this.style.transform = 'scale(1.05)';
            this.style.boxShadow = '0 0 25px rgba(96, 165, 250, 0.7)';
        });
        
        document.getElementById('tagline').addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1)';
            this.style.boxShadow = '0 20px 25px -5px rgba(0, 0, 0, 0.5)';
        });
